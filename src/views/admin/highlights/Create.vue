...
async function handleSubmit() {
  ['title', 'image','created_by','content'].forEach(validateField);
  ...
  try {
    const { data } = await axios.post(`${apiBaseUrl}/api/highlights/create`, form);

    Swal.fire('✅ Success!', data.message || 'Highlights created successfully!', 'success');
