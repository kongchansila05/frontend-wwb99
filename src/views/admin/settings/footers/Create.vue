<template>
  <div class="px-2 py-2">
    ...
    <form @submit.prevent="handleSubmit" novalidate>
      ...
      <!-- Redirect URL -->
      <div class="mb-3">
        <label for="redirect" class="form-label">Redirect Link</label>
        <input
...
async function handleSubmit() {
  ...
  try {
    const { data } = await axios.post(`${apiBaseUrl}/api/footers/create`, form);

    Swal.fire('✅ Success!', data.message || 'Footer created successfully!', 'success');
