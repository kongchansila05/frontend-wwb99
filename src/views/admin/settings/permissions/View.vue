<template>
  <div class="px-2 py-2">
    <div class="d-flex justify-content-between align-items-center mb-3">
      <h2 class="mb-0">List permissions</h2>
    ...
    <div v-else class="table-responsive">
      <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
          <tr v-for="(item, index) in permissionsData" :key="item.id">
    ...
    <!-- Update Popup Modal -->
    <div class="modal fade" id="updatePermissionModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-primary" @click="updatePermission">Save changes</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="createPermissionModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
            <button class="btn btn-primary" @click="createPermission">Create</button>
          </div>
        </div>
      </div>
    </div>
...
function openEditModal(item) {
  ...
  updateModal = new Modal(document.getElementById('updatePermissionModal'))
  updateModal.show()
}
async function updatePermission() {
  ...
  try {
    const { data } = await axios.put(`${apiBaseUrl}/api/permissions/update`, {
    ...
    Swal.fire({
      icon: 'success',
      title: 'Updated!',
      text: data.message || 'Permission has been updated successfully.',
      timer: 2000,
    ...
    Swal.fire({
      icon: 'error',
      title: 'Error',
      text: err.response?.data?.message || 'Error updating permission'
    })
  }
}
// open modal
const openCreateModal = () => {
  ...
  createModal = new Modal(document.getElementById('createPermissionModal'))
  createModal.show()
}
const createPermission = async () => {
 try {
    const { data } = await axios.post(`${apiBaseUrl}/api/permissions/create`, {
...
const fetchpermissions = async () => {
  ...
  try {
    ...
    const res = await fetch(`${apiBaseUrl}/api/permissions?${params}`)
